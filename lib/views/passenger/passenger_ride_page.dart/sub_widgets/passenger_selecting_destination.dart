...
class PassengerSelectingDestinationWidget extends StatefulWidget {
  ...
  PassengerSelectingDestinationWidget({super.key, required this.pickupLocationFormattedAddress, required this.selectedPickUpLocation, required this.onSelectDestination, required this.onSelectDestinationCoordinates, required this.onSelectDestinationMarker});
        ...
        children: [
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                  onPressed: () {
                    if (_destinationItemSelectedIndex < 0 || _destinationItemSelectedIndex >= _placesList.length || _selectedDestinationLocation == null) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(

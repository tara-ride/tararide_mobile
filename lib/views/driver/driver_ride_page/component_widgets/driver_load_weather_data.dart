...
class DriverLoadWeatherDataWidget extends StatefulWidget {
  final DriverRideStatusWeatherDataLoaded weatherData;
  const DriverLoadWeatherDataWidget({super.key, required this.weatherData});

  @override
  // ignore: no_logic_in_create_state
  State<StatefulWidget> createState() => _DriverLoadWeatherDataWidgetState(state: weatherData);
}

class _DriverLoadWeatherDataWidgetState extends State<DriverLoadWeatherDataWidget> {
  final DriverRideStatusWeatherDataLoaded state;

  _DriverLoadWeatherDataWidgetState({required this.state});
  @override
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          context.read<DriverRideStatusBloc>().add(const DriverPostRide());
                        },

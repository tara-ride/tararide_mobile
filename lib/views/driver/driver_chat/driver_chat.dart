...
import 'package:tararide_mobile/views/driver/driver_chat/component_widgets/driver_chat_interaction.dart';
import 'package:tararide_mobile/views/driver/driver_chat/component_widgets/driver_chat_interaction_list_loaded.dart';
...
class DriverChat extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _DriverChatState();
}
                  ...
                  children: [
                    ...
                    BlocConsumer<ChatInteractionBloc, ChatInteractionState>(
                      ...
                      builder: (chatInteractionContext, chatInteractionState) {
                        ...
                        if (chatInteractionState is ChatInteractionListLoaded) {
                          return DriverChatInteractionListLoadedWidget();
                        }
                        if (chatInteractionState is ChatInteractionInitialized) {
                          return Expanded(
                              child: DriverChatInteraction(
